...
return [
    ...
    'financial_rules' => [
        ...
        'PRINSIP LIKUIDITAS SOSIAL: Likuiditas Sosial (Piutang Keluar/Masuk, Hutang Masuk/Keluar) BUKAN Pemasukan maupun Pengeluaran. Hanya mengubah posisi kas (cash) dan posisi aset/kewajiban sementara. Ketika dana pinjaman dipakai beli barang/jasa, transaksi pembelian tetap Pengeluaran + bucket yang sesuai.',
        'Jika expense > income dan ada Hutang Masuk: jelaskan defisit dibiayai Likuiditas Sosial — Essential Living bisa terjaga bukan karena pendapatan cukup, melainkan karena pinjaman sosial. Jangan mengoreksi Income dengan menambahkan pinjaman.',
        'Hutang Masuk menaikkan kas + outstanding hutang; Hutang Keluar menurunkan keduanya. Piutang Keluar menurunkan kas + menambah piutang aktif.',
