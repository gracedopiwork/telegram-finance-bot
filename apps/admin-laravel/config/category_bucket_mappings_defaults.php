...
return [
    // Saving instruments
    ['category' => '*', 'sub_category' => '-', 'bucket' => 'Protection', 'transaction_type' => 'saving', 'nature' => 'Need', 'match_keywords' => 'dana darurat,emergency fund,top up emergency,topup emergency', 'reason' => 'Dana darurat berfungsi sebagai proteksi', 'sort_order' => 1],
    ...
    // Konteks tujuan — jenis tetap Pengeluaran, bucket mengikuti fungsi transaksi.
    ['category' => '*', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'match_keywords' => 'les olahraga,coaching olahraga,kursus olahraga,personal trainer,fitness coach,kelas gym,kelas yoga,kelas pilates,les tenis,coaching tenis,pelatih tenis,kelas tenis,les renang,coaching renang,pelatih renang,kelas renang,les badminton,les bulu tangkis,coaching badminton,coaching basket,coaching sepak bola,coaching futsal,coaching golf', 'reason' => 'Les/coaching olahraga mendukung kesehatan', 'sort_order' => 20],
    ['category' => '*', 'sub_category' => '-', 'bucket' => 'Future Building', 'transaction_type' => 'expense', 'match_keywords' => 'freelancer it,jasa freelancer it,web developer,website bisnis,website usaha,website proyek,software bisnis,software usaha,marketing bisnis,marketing usaha,modal usaha,proyek bisnis,project bisnis,proyek yfd', 'reason' => 'Biaya untuk membangun kapasitas bisnis', 'sort_order' => 21],
    ['category' => '*', 'sub_category' => '-', 'bucket' => 'Future Building', 'transaction_type' => 'expense', 'match_keywords' => 'seminar,simposium,symposium,workshop,sertifikasi,pelatihan,kursus,course,conference,penelitian,buku pengembangan diri,pengembangan diri,self development,psychology of money,psychologi of money,les,coaching,mentoring,kelas piano,les piano,kursus piano,les musik,kelas musik,les vokal,les bahasa,kursus bahasa,public speaking', 'reason' => 'Semua self-development selain olahraga', 'sort_order' => 22],
    ['category' => 'Makan', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'meeting kerja,rapat kerja,meeting klien,ngopi meeting,kopi meeting', 'reason' => 'Makan/minum untuk pertemuan kerja', 'sort_order' => 23],
    ['category' => 'Jajan', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'meeting kerja,rapat kerja,meeting klien,ngopi meeting,kopi meeting', 'reason' => 'Kopi untuk pertemuan kerja', 'sort_order' => 24],
    ['category' => 'Elektronik', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'hp utama rusak,hp rusak,handphone rusak,ganti hp,hp pecah,layar pecah,hp mati', 'reason' => 'Penggantian HP utama rusak', 'sort_order' => 25],
    ['category' => 'Elektronik', 'sub_category' => '-', 'bucket' => 'Future Building', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'laptop kerja,laptop produktif,alat kerja,untuk kerja,modal kerja,laptop kantor,komputer kerja', 'reason' => 'Alat produktif / laptop kerja', 'sort_order' => 26],
    ...
    ['category' => 'Pendidikan', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'spp,uang sekolah,ukt,buku wajib,kebutuhan sekolah anak,les wajib,bimbel sekolah,kuliah', 'reason' => 'Pendidikan wajib', 'sort_order' => 33],
    ...
    ['category' => 'Listrik', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'listrik,pln,token', 'reason' => 'Utilitas tempat tinggal', 'sort_order' => 40],
    ['category' => 'Air', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'pdam,tagihan air,rekening air', 'reason' => 'Utilitas tempat tinggal', 'sort_order' => 41],
    ['category' => 'Kesehatan', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'medical check up,obat,apotek,klinik,dokter,rumah sakit,laboratorium,vitamin', 'reason' => 'Kebutuhan kesehatan', 'sort_order' => 43],
    ['category' => 'Pajak', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'pajak,pph,ppn,pbb,stnk,samsat,administrasi bank', 'reason' => 'Pajak dan administrasi wajib', 'sort_order' => 44],
