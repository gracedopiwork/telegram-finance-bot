...
return [
    ...
    // Context overrides
    ['category' => '*', 'sub_category' => '-', 'bucket' => 'Future Building', 'transaction_type' => 'expense', 'match_keywords' => 'konsumsi meeting,take konten,konten bisnis,meeting bisnis,rapat bisnis,bisnis yfd,modal usaha,website bisnis,software bisnis,marketing bisnis,chatgpt,claude,notion,canva pro,figma', 'reason' => 'Biaya bisnis / tools kerja', 'sort_order' => 21],
    ['category' => 'Pendidikan', 'sub_category' => '-', 'bucket' => 'Future Building', 'transaction_type' => 'expense', 'match_keywords' => 'seminar,workshop,kursus,sertifikasi,conference,pengembangan diri,coaching,mentoring,les', 'reason' => 'Pengembangan diri selalu Future Building', 'sort_order' => 22],
    ...
    ['category' => 'Pendidikan', 'sub_category' => '-', 'bucket' => 'Essential Living', 'transaction_type' => 'expense', 'nature' => 'Need', 'match_keywords' => 'spp,ukt,uang sekolah,buku pelajaran', 'reason' => 'Pendidikan wajib', 'sort_order' => 35],
