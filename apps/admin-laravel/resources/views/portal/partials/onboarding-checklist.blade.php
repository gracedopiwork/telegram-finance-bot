...
<div class="rounded-2xl border-2 border-gold-400/60 bg-gradient-to-br from-navy-800 to-navy-700 text-white shadow-lg overflow-hidden">
    ...
    <ol class="p-5 sm:p-6 space-y-4 {{ $compact ? 'text-sm' : '' }}">
        <li class="flex gap-3">
            ...
            <div>
                <div class="font-semibold">Aktivasi bot Telegram</div>
                <p class="text-white/75 text-sm mt-0.5">Buka bot YFD → kirim <code class="bg-white/10 px-1 rounded text-gold-300">/activate KODE-LISENSI</code> (dari email pembayaran).</p>
            </div>
        </li>
        <li class="flex gap-3">
        ...
        <li class="flex gap-3">
            ...
            <div>
                <div class="font-semibold">Catat transaksi lewat bot</div>
