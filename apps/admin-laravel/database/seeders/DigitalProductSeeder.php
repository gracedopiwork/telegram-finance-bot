    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'description'    => 'Add-on untuk membuka dashboard FTSA di portal YFD: kuesioner FTSA 1–32, behavioral insight, dan indeks kesehatan finansial selama 12 bulan evaluasi. Tidak termasuk bot Telegram atau dashboard transaksi harian.',
                'icon'           => 'psychology',
                'badge'          => 'Tersedia',
                'is_active'      => true,
                'is_featured'    => false,
