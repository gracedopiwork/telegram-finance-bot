...
class CompanyProfileSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            ['key' => 'contact.email',       'value' => 'admin.findoc@yourfinancialdoctor.id',                     'type' => 'text',     'group' => 'contact', 'label' => 'Email',                'sort' => 4],
        ...
        $packages = [
            [
                ...
                'features' => [
                    ...
                    '1x sesi WhatsApp consultation (minimal 60 menit)',
    ...
    private function seedServices(): void
    {
        $services = [
            [
                'section' => 'main',
                'eyebrow' => 'GRATIS',
                'title' => 'Financial Health Check Up / Screening',
                'description' => 'Screening kesehatan finansial untuk mengetahui tahapan finansial Anda saat ini. Dilakukan secara objektif melalui evaluasi singkat terhadap aspek-aspek vital keuangan, sehingga Anda memperoleh gambaran umum kondisi finansial saat ini. Check up ini hanya membutuhkan waktu 3-5 menit hingga Anda mendapatkan hasil screening Anda.',
                'icon' => 'monitor_heart',
                'features' => [
                    'label' => 'Yang akan dievaluasi mencakup',
                    'items' => [
                        'Apakah cashflow Anda sudah sehat?',
                        'Apakah dana darurat sudah cukup?',
                        'Apakah utang masih dalam batas aman?',
                        'Apakah perlindungan keuangan Anda sudah memadai?',
                        'Apakah aset dan investasi sudah mulai bertumbuh?',
                        'Sudah berada di tahap finansial yang mana?',
                    ],
                ],
                'cta_label' => 'Check up sekarang',
                'cta_route' => '__primary_checkup__',
                'sort' => 1,
            ],
            [
                'section' => 'main',
                ...
                'title' => 'YFD First Aid',
                'description' => 'Asisten kesehatan finansial berbasis AI untuk membantu Anda memantau kondisi finansial sehari-hari. Pencatatan dilakukan melalui bot telegram — chat/kirim foto transaksi saja dan YFD akan mengerjakan sisanya. Seluruh transaksi dianalisis secara otomatis menjadi dashboard kesehatan finansial, sehingga Anda dapat memahami kondisi, kebiasaan, dan perkembangan finansial dari waktu ke waktu.',
                'icon' => 'monitoring',
                'features' => [
                    'label' => 'Cakupan',
                    'items' => [
                        'Pencatatan transaksi harian melalui bot telegram (Chat/kirim foto transaksi)',
                        'Dashboard kesehatan finansial',
                        'Monitoring cashflow & budgeting',
                        'Analisis perilaku finansial berbasis data harian dan personalisasi sesuai money personality (FTSA-32)',
                        'Deteksi pengeluaran impulsif',
                        'Insight & rekomendasi otomatis',
                    ],
                    'cta_secondary' => [
                        'label' => 'Unlock Money Personality',
                        'route' => 'company.produk',
                    ],
                ],
                'cta_label' => 'Unlock YFD First Aid',
                'cta_route' => 'company.produk',
                'sort' => 2,
            ],
            [
                'section' => 'main',
                ...
                'description' => 'Konsultasi personal untuk membantu Anda memahami kondisi kesehatan finansial, menemukan akar permasalahan, dan menyusun langkah perbaikan yang sesuai dengan kebutuhan dan tujuan finansial Anda.',
                'icon' => 'stethoscope',
                'features' => [
                    'label' => 'Cakupan',
                    'items' => [
                        'Analisis kondisi finansial',
                        'Diskusi masalah & tujuan finansial',
                        'Strategi perbaikan yang realistis',
                        'Prioritas tindakan yang perlu dilakukan',
                        'Financial Medical Report (FMR)',
                        'Rencana evaluasi berikutnya',
                    ],
                    'footnote' => "Konsultasi dokter financial/sesi: Start Rp 100k (minimal 60 menit).\nTarif konsultasi mitra profesional (misalnya: Tax analyst, Psikolog, psikiater, hipnoterapi, dsb.) tergantung kebutuhan tiap individu.",
                ],
                'cta_label' => 'Lihat Paket Konsultasi',
            ...
            [
                ...
                'description' => 'Pelayanan intensif bagi individu yang mengalami permasalahan finansial kompleks yang membutuhkan pendampingan lebih mendalam. Program ini mengintegrasikan pendekatan finansial, perilaku, dan psikologis melalui kolaborasi dengan mitra profesional YFD untuk membantu proses pemulihan secara bertahap dan menyeluruh.',
                'icon' => 'healing',
                'features' => [
                    'label' => 'Cakupan',
                    'items' => [
                        'Financial trauma',
                        'Adiksi perilaku finansial (judol, pinjol, compulsive spending, dll.)',
                        'Krisis finansial pribadi & keluarga',
                        'Financial burnout & tekanan finansial',
                        'Pendampingan perubahan perilaku finansial',
                        'Kolaborasi dengan psikolog, psikiater, hipnoterapis, dan mitra profesional lainnya sesuai kebutuhan',
                    ],
                    'footnote' => "Konsultasi awal dokter financial: Rp 150k (minimal 60 menit).\nTarif konsultasi mitra profesional (misalnya: Psikolog, psikiater, hipnoterapi, dsb.) tergantung kebutuhan tiap individu.",
                ],
            ...
            [
                ...
                'title' => 'Education Financing & Human Capital Support (Coming soon)',
                'description' => 'Program dukungan pendidikan untuk membantu mencetak generasi Indonesia yang lebih unggul melalui akses pembiayaan yang bertanggung jawab, pendampingan finansial, dan pengembangan kualitas sumber daya manusia.',
                'icon' => 'volunteer_activism',
                'features' => [
                    'label' => 'Cakupan',
                    'items' => [
                        'Akses pembiayaan pendidikan yang bertanggung jawab',
                        'Pendampingan kesehatan finansial penerima',
                        'Persiapan finansial selama masa pendidikan',
                        'Kolaborasi dengan institusi pendidikan & mitra',
                        'Pengembangan human capital Indonesia',
                        'Program keberlanjutan pendidikan',
                    ],
                ],
    ...
    private function seedFaqs(): void
    {
        $faqs = [
            ...
            [
                ...
                'answer'   => 'Konsultasi dapat dilakukan online dan offline. Konsultasi online dapat dilakukan melalui berbagai platform seperti Zoom, Webex, video call, dan sebagainya. Konsultasi offline dapat dijadwalkan jika berdomisili di Bali.',
                'sort' => 2,
            ],
            [
                'category' => 'Umum',
            ...
            [
                ...
                'answer'   => 'Kirim CV dan portofolio Anda ke admin.findoc@yourfinancialdoctor.id dengan subject "Recruitment YFD". Lihat halaman Tim Dokter untuk role yang tersedia.',
                'sort' => 8,
            ],
        ];
