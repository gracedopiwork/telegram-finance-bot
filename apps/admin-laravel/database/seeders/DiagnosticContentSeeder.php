    ...
    private function seedStages(): void
    {
        $defaults = [
            'surviving' => [
                ...
                'risk_description' => 'Kamu berada di fase darurat finansial. Prioritas: stabilkan cash flow, hentikan kebocoran, dan bangun buffer darurat minimum sebelum berpikir investasi.',
                'panel_color' => '#F4A6A6',
                'score_min' => 0,
                'score_max' => 12,
                'sort_order' => 1,
            ...
            'growing' => [
                ...
                'risk_label' => 'Risiko keuangan',
                'risk_description' => 'Kamu sudah keluar dari zona paling rawan, namun struktur keuangan masih perlu diperkuat. Fokus pada disiplin menabung, proteksi dasar, dan dana darurat yang memadai.',
                'panel_color' => '#7EC8C8',
                'score_min' => 13,
                'score_max' => 22,
                'sort_order' => 2,
            ...
            'steady' => [
                ...
                'risk_label' => 'Risiko keuangan',
                'risk_description' => 'Fondasi keuangan relatif solid. Fokus berikutnya: perbesar investasi terencana, optimalkan aset, dan bangun passive income menuju financial freedom.',
                'panel_color' => '#8FD9A8',
                'score_min' => 23,
                'score_max' => 33,
                'sort_order' => 3,
            ...
            'comfortable' => [
                ...
                'risk_label' => 'Risiko keuangan',
                'risk_description' => 'Kondisi keuangan kuat dan relatif mandiri. Pertahankan disiplin, arahkan kekayaan ke tujuan jangka panjang, legacy, dan dampak positif.',
                'panel_color' => '#8BB8E8',
                'score_min' => 34,
                'score_max' => 39,
                'sort_order' => 4,
